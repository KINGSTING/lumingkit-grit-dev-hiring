...
erDiagram
    ...
    api_author {
        ...
        longtext short_bionote
        text image_url
    }
    
    api_publication_authors {
        int id PK
        int publication_id FK
        int author_id FK
    }
    
    api_publisher ||--o{ api_publication : "has many"
    api_publication ||--o{ api_publication_authors : "has many"
    api_author ||--o{ api_publication_authors : "has many"
```